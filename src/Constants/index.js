...
export const portfolio = [
  {
    image: aiSummarizer,
    title: "AI Url & Pdf Summarizer",
    description:
      "An AI-powered web application that allows users to upload PDF documents or paste URLs and receive intelligent, structured summaries generated by an LLM. Features secure user accounts, summary history, and a responsive interface.",
    github: {
      icon: git,
      link: "https://github.com/anmolgupta313/ai-pdf-text-summarizer",
    },
    deployedLink: {
      icon: web,
      link: "https://ai-pdf-text-summarizer.vercel.app/",
    },
  },
  {
    image: airBnb,
